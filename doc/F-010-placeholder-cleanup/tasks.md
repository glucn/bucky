...
- [x] 2. Add cleanup mode to transactions page
...
- [x] 3. Add inline reassignment for placeholder rows
...
- [x] 4. Align Edit Transaction destination behavior
...
- [x] 5. Keep shared option logic consistent across cleanup and edit flows
...
- [x] 6. Add deterministic test hooks for automation
