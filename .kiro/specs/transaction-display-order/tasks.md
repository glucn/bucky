...
- [x] 2. Add IPC handlers for transaction reordering
  - [x] 2.1 Implement move-transaction-up IPC handler
    - Accept entryId parameter
  ...
  - [x] 2.2 Implement move-transaction-down IPC handler
    - Accept entryId parameter
  ...
  - [x] 2.3 Add IPC handler types to preload script
    - Add moveTransactionUp to electron API
    - Add moveTransactionDown to electron API
    - _Requirements: 4.1, 4.2_

- [x] 3. Update transaction display to show reorder controls
  - [x] 3.1 Add reorder buttons to transaction rows
  ...
  - [x] 3.2 Implement reorder button click handlers
  ...
  - [x] 3.3 Group transactions by date for button state logic
...
- [x] 4. Ensure default displayOrder for new transactions
  - [x] 4.1 Update transaction creation to set displayOrder
